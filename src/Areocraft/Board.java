...
/**
 * This is the board of the Game, actually this is 
 * a JPanel where the craft and its action will take place
 * @author Gustavo
 */
...
//    private Craft craft;
    ...
    public Board(){
        ...
        //Is created below
        addKeyListener(new CraftController());
